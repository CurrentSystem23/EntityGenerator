...
";
  ...
  private static UserDefinedTableTypeColumnDto GetUserDefinedTableTypeRead(SqlDataReader reader)
  {
    UserDefinedTableTypeColumnDto dto = new()
    {
      ...
      ColumnType = NormalizeTypeName(reader.GetString(7)),
      ColumnTypeDataType = reader.GetEnum<Models.Enums.DataTypes>(NormalizeTypeName(reader.GetString(7)), Models.Enums.DataTypes.Unknown),
