...
namespace EntityGenerator.CodeGeneration.Languages.NET.CSharp
{
  public abstract partial class NETCSharp : IBusinessLogicGenerator
  {
    ...
    protected void BuildInterfaceMethod(ProfileDto profile, Schema schema, MethodType methodType, string name, bool isTable, bool async, string parametersStr = null, string parametersWithTypeStr = null)
    {
    ...
    {
      BuildInterfaceMethod(profile, schema, methodType, function.Name, false, true, ParameterHelper.GetParametersString(function.Parameters), ParameterHelper.GetParametersStringWithType(function.Parameters, this));
    }
    ...
    {
      BuildInterfaceMethod(profile, schema, methodType, table.Name, true, true);
    }
    ...
    {
      BuildInterfaceMethod(profile, schema, methodType, tableValuedFunction.Name, false, true, ParameterHelper.GetParametersString(tableValuedFunction.Parameters), ParameterHelper.GetParametersStringWithType(tableValuedFunction.Parameters, this));
    }
    ...
    {
      BuildInterfaceMethod(profile, schema, methodType, view.Name, false, true);
    }
  }
}
